...
import br.com.assinador.agente.gui.panel.documento.listener.SelecaoDiretorioDestinoActionListener;

class DestinoLowerPanel extends JPanel {

	private static final long serialVersionUID = -8885728689572730475L;

	public DestinoLowerPanel(ExtratorComponentsVO componentsVO) {
