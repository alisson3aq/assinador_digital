...
import br.com.assinador.agente.gui.panel.documento.listener.RemoverSelecionadosActionListener;
import br.com.assinador.agente.gui.panel.documento.listener.SelecaoDocumentoActionListener;

class OrigemUpperPanel extends JPanel {
	
	private static final long serialVersionUID = -5540154856994635443L;
	
	public OrigemUpperPanel(ExtratorComponentsVO componentsVO) {
		
		JSeparator separator = new JSeparator();
		JLabel lblDocumentos = new JLabel("Documentos assinados");
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addComponent(lblDocumentos, GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblDocumentos, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
